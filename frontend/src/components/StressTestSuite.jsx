...
import { Play, ShieldAlert, CheckCircle2, XCircle, RefreshCw, Zap, Flame, Repeat, ShieldCheck, VolumeX } from 'lucide-react';
  ...
  return (
    <div className="w-full glass-panel rounded-2xl border border-zinc-800 p-5 shadow-2xl flex flex-col gap-4">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-400 font-mono">
              6 Deterministic verification scenarios for judges to evaluate hard voice mechanics
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        ...
        {/* TEST 5: Automatic Interruption (No Click) */}
        <div className="glass-card p-3.5 rounded-xl border border-zinc-800 flex flex-col justify-between gap-3 hover:border-[#FFD400]/50 transition-colors">
          <div className="flex flex-col gap-1 font-mono">
            <div className="flex items-center justify-between">
